<script>
  ...
  export let type = "info"; // "warning" | "error" | "info" | "success"
  export let posAbs = false;
...
<style lang="scss">
  ...
  .error {
    background-color: theme.$support-error;
  }
  ...
  .info {
    background-color: theme.$support-info;
  }
