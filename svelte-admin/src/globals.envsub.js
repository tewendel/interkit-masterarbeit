...
console.log(`INTERKIT_SERVER_URL=${INTERKIT_SERVER_URL}`)

INTERKIT_IMAGE_TAG = "$INTERKIT_IMAGE_TAG"
console.log(`INTERKIT_IMAGE_TAG=${INTERKIT_IMAGE_TAG}`)