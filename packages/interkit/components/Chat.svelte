<script>
  ...
  const dummyMessages = [
    ...
    { id: 'm50', sender: 'u', payload: { type: 'image', options: { zoom: true } } },
    { id: 'm55', sender: 's', payload: { type: 'system', text: 'another system message, followed by two system images, first placed "me", then "other"' } },
    { id: 'm56', sender: 's', payload: { type: 'systemImage', options: { zoom: true, placement: 'me' } } },
    { id: 'm57', sender: 'u', payload: { type: 'systemImage', options: { zoom: true, placement: 'other' } } },
