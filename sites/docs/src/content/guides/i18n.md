...
* It takes a **comma-separated** list of language codes.  
  ...
  Example: `de,en,fr`
* The language codes should follow
  [the standard](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/lang#language_tag_syntax)
  for language features to work
  (like the browser's built-in hyphenation, or translation extensions)
