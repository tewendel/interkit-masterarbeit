    ...
    >
      ...
      >
        ...
        <svelte:fragment slot="label">
          ...
          <StaticText
             text={$lang ? ($translations[$lang] && $translations[$lang]["$button_more"] ? $translations[$lang]["$button_more"] : "button_more") : ($translations.en && $translations.en["$button_more"] ? $translations.en["$button_more"] : "…")}>
          </StaticText>
        </svelte:fragment>
        <svelte:fragment slot="content">
          <DataLoaderSingle
    ...
    >
      ...
      >
        ...
        <svelte:fragment slot="content">
          ...
          <svelte:fragment slot="left">
            <PopoutAudioButton
               audioColumn={$lang ? "3d764bfb-ebf1-4e17-b756-e819c1d8794c/" + "audio$lang".replace("$lang", "$" + $lang) : "3d764bfb-ebf1-4e17-b756-e819c1d8794c/audio$lang"}   buttonOptions={undefined}
            >
            </PopoutAudioButton>
          </svelte:fragment>
          <svelte:fragment slot="center">
