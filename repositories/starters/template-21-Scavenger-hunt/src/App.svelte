    ...
    >
      ...
      <svelte:fragment slot="BottomBar">
          ...
          >
            ...
            <NavButton
                  disabled={false}
               effect={{"effectType":"route","path":"/map"}}
            >
              <Icon
                 type="Thin-Map"
                 inverse={false}
      ...
      <svelte:fragment slot="Content">
        ...
        >
          ...
          <svelte:fragment slot="content">
            ...
            <svelte:fragment slot="iftrue">
              <StaticText
                 text="Congratulations, this was the last cat."
              >
              </StaticText>
            </svelte:fragment>
            <svelte:fragment slot="else">
              ...
              <svelte:fragment slot="iftrue">
                <StaticText
                   text="You scanned this cat! Look at the map to find more."
                >
                </StaticText>
              </svelte:fragment>
              <svelte:fragment slot="else">
                ...
                >
                  ...
                  >
                    <StaticText
                       text="When you're on site, scan the cat!"
                    >
                    </StaticText>
                  </TextFormat>
                </Spacing>
                <ButtonBar
                  ...
                  <Button
                     ...
                     flex="fill"
                     disabled={false}
                     effect={{"effectType":"setUIKey","value":"true","key":"showScanner"}}
                  >
                  </Button>
                </ButtonBar>
                  <IfUIKey
                  ...
                  <svelte:fragment slot="iftrue">
                    ...
                    >
                      ...
                      <svelte:fragment slot="Content">
                        <QRScanner
                           elementKeyColumn="elements/index"
                           closeEffect={{"effectType":"setUIKey","value":"false","key":"showScanner"}}
                           scanEffect={{"effectType":"actionTrigger","trigger":"scan"}}
                        >
                        </QRScanner>
                      </svelte:fragment>
                      </TopBarShell>
