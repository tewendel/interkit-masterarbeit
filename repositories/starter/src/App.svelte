<script>
  import HeadlinePage from 'interkit/components/HeadlinePage.svelte'
  import BottomMenu from 'interkit/components/BottomMenu.svelte'
...
<BottomMenu>
  <div slot="buttons">
      <BottomMenuButton label="one"/>
      <BottomMenuButton label="two"/>
