<script>
  ...
  onMount(async () => {
    ...
    const loadComponent = async (component) => {
      let c;
      if(component == "Dashboard") c = (await import('interkit/components/Dashboard.svelte')).default;
      if(component == "Archive") c = (await import('interkit/components/Archive.svelte')).default;
      if(component == "Map") c = (await import('interkit/components/Map.svelte')).default;
      return c;
    }
  ...
  import IonTab from 'interkit/components/IonTab.svelte'
