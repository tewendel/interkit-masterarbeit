...
app.put(
  ...
  rawBodyParser,
  board_node_api.boards.update
);
app.patch(
  "/boards/:projectId/:boardId",
  rawBodyParser,
  board_node_api.boards.patch
);
app.delete("/boards/:projectId/:boardId", board_node_api.boards.delete);
app.put(
  "/boards/:projectId/renameboard/:oldBoardId/:newBoardId",
  board_node_api.boards.renameBoard
);
app.put(
  "/boards/:projectId/:boardId/renamenode/:oldNodeId/:newNodeId",
  board_node_api.boards.renameNode
);

// dont need it, build it into read board
// app.get('/boards/:projectId/:boardId/nodes', board_node_api.nodes.list)
app.post(
  "/boards/:projectId/:boardId/nodes/:nodeId",
  rawBodyParser,
  board_node_api.nodes.create
);
app.get(
  "/boards/:projectId/:boardId/nodes/:nodeId",
  board_node_api.nodes.create
...
app.put(
  "/boards/:projectId/:boardId/nodes/:nodeId",
  rawBodyParser,
  board_node_api.nodes.update
);
app.delete(
  "/boards/:projectId/:boardId/nodes/:nodeId",
  board_node_api.nodes.delete
);
...
app.use("/git", git_server_middleware);
